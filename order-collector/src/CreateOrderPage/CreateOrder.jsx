                        ...
                        <div className="form-right-side">
                            <div className="product-table">
                                ...
                                <div className="row">
                                    ...
                                    <button type="radio"><img id="trash-pic" src={TrashPic} /></button>
                                </div>
                                <button id="add-product-btn"><img id="add-icon" src={PlusPic} /> Add a product</button>
                            </div>
                        </div>
                    </div>
                    <div className="btn-row">
                        <button id="sendBtn"> {SendOrderPic} <b> Create Order </b></button>
                        <button id="sendBtn"> {MenuBtn} <b>Order Status</b> </button>
                    </div>
